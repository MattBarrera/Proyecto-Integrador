<?php require_once("config.php"); 
	...
	if ($_POST) {
		...
		if (empty($errores)) {
			...
			$productoAReactivar = $repositorio->getProductRepository()->productoAReactivarEnJSON($_POST, $productoFoto);
			$repositorio->getProductRepository()->modificarProducto($productoAReactivar);
...
<?php require_once("include/head.php"); ?>
 <body>
	...
	<section id="register">
			<div class="title"><h2>Modificar Producto a Reactivar</h2></div>
