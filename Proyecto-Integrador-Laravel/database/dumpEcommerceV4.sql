...
INSERT INTO `categoria` VALUES (1,'Clothes',0,NULL,NULL),(2,'Shoes',0,NULL,NULL),(3,'Accesories',0,NULL,NULL),(4,'Pantalones',1,NULL,NULL),(5,'Remeras',1,NULL,NULL),(6,'Abrigos',1,NULL,NULL),(7,'Camisa',1,NULL,NULL),(8,'Ropa Interior',1,NULL,NULL),(9,'Carteras',3,NULL,NULL),(10,'Cinturones',3,NULL,NULL),(11,'Bijouterie',3,NULL,NULL);
...
INSERT INTO `color` VALUES (1,'Rojo',NULL,NULL),(2,'Amarillo',NULL,NULL),(3,'Azul',NULL,NULL),(4,'Marron',NULL,NULL),(5,'Violeta',NULL,NULL);
...
INSERT INTO `empresa` VALUES (1,'Maria Cher','e-shop@mariachereshop.com.ar',2147483647,'47440109','direccion 1234','cherLogoFB.png',1,'2016-08-08 01:05:58','2016-08-08 01:05:58');
...
INSERT INTO `empresaHasUsers` VALUES (1,1,'2016-08-08 01:05:58','2016-08-08 01:05:58');
...
CREATE TABLE `followers` (
  `users_id` int(10) unsigned NOT NULL,
  `users_id1` int(10) NOT NULL DEFAULT '0',
  ...
  KEY `fk_followers_empresa1_idx` (`empresaId`),
  CONSTRAINT `fk_followers_empresa1` FOREIGN KEY (`empresaId`) REFERENCES `empresa` (`empresaId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `followers` VALUES (1,0,1,'2016-08-08 06:58:48','2016-08-08 06:58:48'),(1,2,0,'2016-08-08 06:58:55','2016-08-08 06:58:55'),(1,3,0,'2016-07-31 23:45:26','2016-07-31 23:45:26');
...
INSERT INTO `genero` VALUES (1,'Masculino',NULL,NULL),(2,'Femenino',NULL,NULL);
...
INSERT INTO `users` VALUES (1,'Manuel','Vilche',47440109,'manuelvilche@gmail.com',1,'fotoPerfil.jpg','1991-10-19','$2y$10$/fh.cBdG8iff4q3XsrJWY.Fy6lOB6V3SUwBr6I./ddQ1utmPUO/ru','1','OLtbchSeIqYuj0ezZLPo7h6i2MvIsXSr8wAfRTg37LZV4Le7QomLodQELZhL','2016-07-19 21:18:28','2016-08-06 03:17:48'),(2,'Bianca','Pallaro',12345678,'biancapallaro@gmail.com',2,'avatar_2x.png','1990-12-10','$2y$10$vPsjFebLX3ca4.ZezLBCZOn/VW00wa3Z0kWPf7uvPFlx76zsFnpLq','1','Qhipj83SelToZLvWUuLSN7NXjLlvGxMDmbeprbWSxWtHTDOoA5E7jGpX1VE4','2016-07-26 05:08:31','2016-07-26 05:08:38'),(3,'Matias','Barrera',12345678,'mb_herfarth@hotmail.com',1,'avatar_2x.png','1990-12-10','$2y$10$94Q2cfNvx0lR.lavz9.UgeLhS6fFIePsmXjYxUpqcf3tDpLjxvnra','1','I75WruQ4wOb8Ee5b77IJ5jkFrrci3g740bgva81tsV9YsyPp6dcff8Rhkhw9','2016-07-26 05:10:44','2016-07-26 05:16:53'),(13,'Pedro','Vilche',47440109,'manuelvilche+4@gmail.com',1,'avatar_2x.png','1991-11-19','$2y$10$OpTMVyk6DDkOtBDYnO.IyeHAzFg0Quxj.LxcN2ecZNL4OO8EkMnmy','1',NULL,'2016-08-01 00:15:46','2016-08-01 00:15:46');
...
INSERT INTO `visitas` VALUES (1,4,2,'2016-08-08 07:15:53','2016-08-08 07:24:46'),(2,2,1,'2016-08-08 07:28:19','2016-08-08 07:28:22'),(3,1,3,'2016-08-08 07:47:35','2016-08-08 07:47:35');
...
-- Dump completed on 2016-08-08  3:06:02
