...
<main>
  ...
  <section style="position:relative">
    <div id="social" style="position:absolute;top:15px">
      <div><a href="http://www.facebook.com"> <img src="{{ asset('img/facebook.svg') }}" width="30" height="40" /></a></div>
      <div><a href="http://www.google.com"> <img src="{{ asset('img/google.svg') }}" width="30" height="40"/></a></div>
      <div><a href="http://www.linkedin.com"> <img src="{{ asset('img/linkedin.svg') }}" width="30" height="40" style: /></a></div>
      <div><a href="http://www.twitter.com"> <img src="{{ asset('img/twitter.svg') }}" width="30" height="40"/></a></div>
      <div><a href="mailto:biancapallaro@gmail.com"><img src="{{ asset('img/email.svg') }}" width="30" height="40"/></a></div>
      <div><a href="http://www.youtube.com"><img src="{{ asset('img/youtube.svg') }}" width="30" height="40"/></a></div>
    </div>
  </section>
